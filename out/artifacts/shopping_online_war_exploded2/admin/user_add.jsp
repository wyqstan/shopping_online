...
<jsp:include page="/admin/header.jsp"></jsp:include>
	...
	<br><br>
	<form class="form-horizontal" action="http://43.139.95.90:8080/shop/admin/user_add" method="post">
		...
		<div class="form-group">
			<label for="input_name" class="col-sm-1 control-label" value="${u.email }" />邮箱</label>
			<div class="col-sm-6">
				<input type="text" class="form-control"  name="email" required="required" value="${u.email }" />
			</div>
		</div>
		<div class="form-group">
			<label for="input_name" class="col-sm-1 control-label">密码</label>
			<div class="col-sm-6">
				<input type="text" class="form-control"  name="password" required="required" value="${u.password }" />
			</div>
		</div>
		<div class="form-group">
