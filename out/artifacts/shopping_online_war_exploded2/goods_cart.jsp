	...
	<div class="cart-items">
		<div class="container">
				...
				<div class="cart-header col-md-6">
					<div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							<a href="http://43.139.95.90:8080/shop/goods_detail?id=${item.key}">
								<img src="http://43.139.95.90:8080/shop${item.value.goods.cover}" class="img-responsive">
							</a>
						</div>
						<div class="cart-item-info">
							<h3><a href="http://43.139.95.90:8080/shop/goods_detail?id=${item.key}">${item.value.goods.name}</a></h3>
			...
			<div class="cart-header col-md-12">
				...
				<a class="btn btn-success btn-lg" style="margin-left:74%" href="http://43.139.95.90:8080/shop/order_submit">提交订单</a>
			</div>
