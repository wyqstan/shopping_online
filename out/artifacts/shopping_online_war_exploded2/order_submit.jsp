...
<body>
	...
	<div class="cart-items">
		<div class="container">
			<h2>确认收货信息</h2>
			<form class="form-horizontal" action="http://43.139.95.90:8080/shop/order_confirm" method="post" id="payform">
				...
				<div class="row">
					<label class="control-label col-md-1">所在省份</label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="province" value="${user.province }" style="height:auto;padding:10px;" placeholder="输入所在省份" required="required"><br>
					</div>
				</div>
				<div class="row">
					<label class="control-label col-md-1">所在城市</label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="city" value="${user.city }" style="height:auto;padding:10px;" placeholder="输入所在城市" required="required"><br>
					</div>
				</div>
				<div class="row">
					<label class="control-label col-md-1">具体收货地址</label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="address" value="${user.address }" style="height:auto;padding:10px;" placeholder="输入具体收货地址" required="required"><br>
					</div>
				</div>
