...
public class User {
	...
	public User(int id, String username, String email, String password, String name, String phone, String address, boolean isadmin, boolean isvalidate, double total_price, String city, String province) {
		this.id = id;
		this.username = username;
		this.email = email;
		this.password = password;
