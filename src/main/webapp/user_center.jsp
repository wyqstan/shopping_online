				...
				<c:if test="${!empty msg }">
				 ...
				 <c:if test="${!empty failMsg }">
					...
					<div class="register-top-grid">
						<h3>个人中心</h3>
						<form action="http://43.139.95.90:8080/shop/user_changeaddress" method="post">
						<h4>收货信息</h4>
						<div class="input">
						...
						<div class="input">
							<span>所在省份</span>
							<input type="text" name="province" value="${user.province }" placeholder="请输入所在省份">
						</div>

						<div class="input">
							<span>所在城市</span>
							<input type="text" name="city" value="${user.city }" placeholder="请输入所在城市">
						</div>
						<div class="input">
							<span>具体收货地址</span>
						...
						<form action="http://43.139.95.90:8080/shop/user_changepwd" method="post">
						<h4>安全信息</h4>
						<div class="input">
							<span>原密码</span>
